...
public class OAuthAttributes {
    ...
    /**
     * SocialType에 맞는 메서드를 호출해 OAuthAttributes 객체 반환
     * 파라미터: userNameAttributeName -> OAuth2 로그인 시 PK가 되는 값
     * attributes: OAuth 서비스의 유저 정보들
     * 소셜별 of 메서드(ofNaver, ofKakao, ofGoogle)들은 각각 소셜 로그인 API에서 제공하는
     ...
     * OAuth2UserInfo에서 socialId(식별값), nickname, imageUrl을 가져와 build
