...
public abstract class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        /**
         * DefaultOAuth2UserService 객체를 생성해 loadUser(userRequest)를 통해 DefaultOAuth2User 객체를 생성 후 반환
    ...
    /**
     * OAuthAttributes의 toEntity() 메서드를 통해 빌더로 User 객체 생성 후 반환
